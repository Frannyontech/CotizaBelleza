...
ROOT_URLCONF = 'cotizabelleza.urls'
...
WSGI_APPLICATION = 'cotizabelleza.wsgi.application'
...
EMAIL_TEMPLATES = {
    'price_alert': {
        ...
        'html_template': 'emails/price_alert.html',
        'text_template': 'emails/price_alert.txt',
    }
}
